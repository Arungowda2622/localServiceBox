...
const AddProperties = ({ navigation }) => {
    ...
    /* ---------------------------------- */
    useEffect(() => {
        const unsub = onSnapshot(collection(db, "nearbyProperties"), (snap) => {
    ...
    const uploadImageToFirebase = async (uri) => {
        ...
        const filename = `nearbyProperties/${Date.now()}.jpg`;
    ...
    const handleSubmit = async () => {
        if (!name || !price || !location || !phone || !description) {
        ...
        try {
            ...
            await addDoc(collection(db, "nearbyProperties"), {
                name,
                location,
                price,
                phone,
     ...
     /* ---------------------------------- */
        ...
        const handleUpdate = async () => {
            ...
            try {
                ...
                await updateDoc(doc(db, "nearbyProperties", editItem.id), {
                    name: editItem.name,
        ...
        const handleDelete = (item) => {
            ...
            Alert.alert("Delete Property", "Are you sure?", [
                ...
                },
                {
                    ...
                    onPress: async () => {
                        try {
                            await deleteDoc(doc(db, "nearbyProperties", item.id));
                        } catch (e) {
                            console.log(e);
                        } finally {
                            setDeleteId(null);
    ...
    return (
        <View style={styles.container}>
            <Header title={"Add Properties"} navigation={navigation} />
