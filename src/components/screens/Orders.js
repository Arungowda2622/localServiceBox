...
const Orders = ({ navigation }) => {
  ...
  const [activeTab, setActiveTab] = useState("product"); // "product" or "bike"
    ...
    <View style={styles.card}>
      ...
      {item.paymentMethod === "Online Payment" && (
        <Text style={styles.utr}>
          UTR: {item.utrNumber ? item.utrNumber : "N/A"}
        </Text>
      )}
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text
            style={[
              ...
              activeTab === "product" && styles.tabButtonTextActive,
            ]}
          >
            Products
          </Text>
        ...
        <TouchableOpacity
          style={[
            styles.tabButton,
            activeTab === "bike" && styles.tabButtonActive,
          ]}
        ...
        >
          <Text
            style={[
              styles.tabButtonText,
              activeTab === "bike" && styles.tabButtonTextActive,
            ]}
          >
            Bike Rides
          </Text>
